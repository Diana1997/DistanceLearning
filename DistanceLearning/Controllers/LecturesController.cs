...
namespace DistanceLearning.Controllers
{
    public class LecturesController : Controller
    {
        ...
        {
            var lectures = db.Lectures.Include(l => l.Lesson);
        ...
        public ActionResult Create([Bind(Include = "LectureID,Name,Path,LessonID,Links")] Lecture lecture)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "LectureID,Name,Path,LessonID,Links")] Lecture lecture)
        {
            if (ModelState.IsValid)
            {
