...
namespace DistanceLearning.Controllers
{
    public class LessonsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "LessonID,Name,CourseID")] Lesson lesson)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "LessonID,Name,CourseID")] Lesson lesson)
        {
            if (ModelState.IsValid)
            {
